...
alias perl_code_structure="perl -ne'print if /^[^#]*(?<!\\$)\b(sub|if|elif|else|for|foreach|while|unless|until|do|next|last|redo|continue|given|when|goto|return|die|try|catch)\b/'"
